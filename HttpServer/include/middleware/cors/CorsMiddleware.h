...
namespace http
{
    namespace middleware
    {
        ...
        private:
            ...
            void handlePreflightRequest(const HttpRequest &request, HttpResponse &response); // 处理OPTIONS预检请求
            void addCorsHeader(HttpResponse &response, const std::string &origin);
